 ...
 * @author Sam
 */
public class ChangePatientServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("delete".equals(delete)) {
            ...
            Client deleteClient = new Client(); //populate with table attributes
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ChangePatientServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
